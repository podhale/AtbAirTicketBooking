        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <c:forEach var="result" items="${result}">
                    ...
                    <tr>
                    <td  align="center"><%=i++%></td><td align="center">${result.airline} </td><td> ${result.startAirport} </td><td  align="center"> ${result.startTime}</td><td  align="center">${result.endAirport} </td><td  align="center"> ${result.endTime}</td> <td  align="center"> ${result.price} zł</td><td><form:form action="${pageContext.request.contextPath}/personalData" method="post">  <input type="hidden" name="id_lotu" size="1" value="${result.id}"> <button type="submit" class="btn btn-primary">wybierz</button></form:form></td></tr>
                </c:forEach>
